...
class Main:
    ...
    def draw_score(self):
        ...
        score_y = int(cell_size * cell_number - 578)
        score_rect = score_surface.get_rect(center = (score_x, score_y))
        banana_rect = banana.get_rect(midright = (score_rect.left, score_rect.centery))
        bg_rect = pygame.Rect(banana_rect.left, banana_rect.top, banana_rect.width + score_rect.width + 5, banana_rect.height)
        
        pygame.draw.rect(screen, (56,75,12), bg_rect, 1)
...
img = pygame.transform.scale(banana, (cell_size, cell_size))
img1 = pygame.transform.scale(banana, (5, 5))
